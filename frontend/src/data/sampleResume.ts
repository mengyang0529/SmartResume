  ...
  sections: [
    ...
    },
    {
      ...
      entries: [
        ...
        { id: 'cert-4', title: '語学', subtitle: '', location: '', startDate: '', endDate: '', description: '実用英语技能検定2级' },
      ],
    },
    {
      id: 'sec-motivation',
      ...
      entries: [
        {
          ...
          description: '貴社の事业内容に強く共感し、これまで培ってきたシステム開発の経験を活かして贡献したいと考えています。通勤時間は1时间以内を希望します。リモートワークの可否については面接時にご相談させていただきたく存じます。',
        },
      ],
    },
  ],
...
export const SHOKUMU_SAMPLE_DATA: ResumeData = {
      ...
      entries: [
        {
          ...
          startDate: '',
          endDate: '',
          description: '大学卒業后、广告代理店以及人材紹介会社において提案営業に従事。新規開拓から既存顧客に対する深耕営業まで幅広く経験。現在はマネージャーとしてメンバーの育成・指导および業績マネジメントを行っている。',
        },
      ],
    },
    {
  ...
  summary: '大学卒業后、广告代理店以及人材紹介会社において提案営業に従事。新規開拓から既存顧客に対する深耕営業まで幅広く経験。現在はマネージャーとしてメンバーの育成・指导および業績マネジメントを行っている。',
}
