...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1e1e22] py-24 px-8">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {templates.map((template, i) => (
            <motion.div
              ...
              className="group bg-[#26262c] border border-gray-700/50 hover:border-red-600/50 transition-all p-10 relative overflow-hidden"
            >
              {/* Corner Accent */}
              ...
              <div className="mb-12">
                ...
                <h3 className="text-2xl font-black uppercase tracking-tight text-gray-300 mb-4 group-hover:text-red-500 transition-colors">{template.name}</h3>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <button className="w-full py-4 border border-gray-700 text-gray-500 font-black uppercase tracking-widest text-[10px] hover:border-gray-600 hover:text-gray-300 transition-all flex items-center justify-center space-x-2">
                   <FaEye />
                   <span>Preview</span>
                </button>
              </div>
