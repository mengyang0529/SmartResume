      ...
      entries: [
        {
          ...
          endDate: '2018年3月',
          description:
            '情報セキュリティ研究室に所属\n毕业研究: 「IoT機器における機械学習を用いた異常検知システムの提案」',
        },
        {
          id: 'entry-edu-2',
          title: '都立青山高等学校',
        ...
        },
        {
          ...
          endDate: '2021年3月',
          description:
            '社内勤怠管理システムのリプレイス、PHP(Laravel)からPython(Django)への移行を主导\nPostgreSQLを用いたDB设计とRESTful APIの開発を担当\n既存バッチ处理をAWS Lambdaに移行し運用コストを30%削減',
        },
      ],
    },
    {
      ...
      entries: [
        ...
        },
        {
          ...
          startDate: '',
          endDate: '',
          description: 'AWS ソリューションアーキテクト アソシエイト',
        },
        {
          id: 'cert-3',
          title: 'Java',
          ...
          startDate: '',
          endDate: '',
          description: 'Oracle Certified Java Programmer Gold',
        },
        {
          id: 'cert-4',
          title: '語学',
      ...
      entries: [
        {
          ...
          endDate: '',
          description:
            '学生時代からものづくりに興味を持ち、大学では情報セキュリティを専攻。新卒で株式会社未来システムに入社し、Webシステムの開発に従事。株式会社テックイノベーションでは金融系システムの開発を通じて、高品質なソフトウェアを提供することの重要性を学びました。\n\n自己PRとしては、课题に対して原因を根本から追求し、持続可能な解決策を提案できる点です。前職ではレガシーシステムの移行プロジェクトにおいて、单なる移行ではなく、プロセス改善やコスト削減にも贡献しました。\n\n趣味はランニングと読书です。周に3回程度ランニングを続けており、フルマラソンにも挑戦した経験があります。',
        },
      ],
    },
    {
      ...
      entries: [
        {
          ...
          endDate: '',
          description:
            '貴社の事业内容に強く共感し、これまで培ってきたシステム開発の経験を活かして贡献したいと考えています。通勤時間は1时间以内を希望します。リモートワークの可否については面接時にご相談させていただきたく存じます。',
        },
      ],
    },
  ],
      ...
      entries: [
        {
          ...
          endDate: '',
          description:
            '大学卒業后、广告代理店以及人材紹介会社において提案営業に従事。新規開拓から既存顧客に対する深耕営業まで幅広く経験。現在はマネージャーとしてメンバーの育成・指导および業績マネジメントを行っている。',
        },
      ],
    },
    {
      ...
      entries: [
        {
          ...
          endDate: '2021年3月',
          description:
            '事業内容：総合印刷・総合广告代理店业\nSF事业部第一グループに配属。新規開拓営業（テレアポ、HP問い合わせ対応）を担当。既存顧客への深耕営業も経験（既存顧客比率80%）\n担当エリア：首都圏エリア。大手法人约3社（担当店舗数120店）を担当\n大型ショッピングモール内スーパーのイベント情報を本部广告担当者から入手。店舗責任者へのアプローチを実施し、店頭POP（パネル、チラシなど）の製作・印刷契約を獲得',
        },
        {
          id: 'entry-work-2',
          title: '綜合印刷株式会社',
        ...
        },
        {
          ...
          endDate: '2024年3月',
          description:
            '事業内容：人材紹介业\n人材採用に関する提案営業を実施。店长・SV職・店舗統括・店舗開発職などの採用支援を担当\n担当エリア：都内各地。取引先は常时约20社（主に外食産業、服务业）\n担当企業の魅力を伝える説明会を定期的に開催。加えて転職希望者の反応やイメージなどの情報を収集し企业側に共有。採用コンセプトや採用手法の改善を提案・実施',
        },
        {
          id: 'entry-work-4',
          title: 'キャリアデザイン株式会社',
