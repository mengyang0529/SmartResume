import { type RichTextBlock, type BlockType } from '@app-types/richText';
import { EDITOR_COLORS } from '@constants/editor';
...
export default function BlockSideMenu({
  ...
  return (
    <motion.div
      ...
      animate={
        activeBlockId === block.id || blocks.length === 1
          ? { opacity: 1, x: 0 }
          : { opacity: 0, x: -5 }
      }
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      block.type === bt.type
                        ...
                        : 'text-warm-400 hover:bg-[rgba(0,0,0,0.05)] hover:text-[rgba(0,0,0,0.95)]'
                    )}
                  >
                    {bt.label}
                  </button>
